...
- design
    - `xCOMMAND_LINE_INPUT` can be considered as a class processing a specific command
        - command line string given by the user
        - help text for the command usage
        - command handler
        - expected number of arguments followed by the command
    - `FreeRTOS_CLIProcessCommand` used to process the command
        - check the actual and expected number of arguments match
        - invoke the command handler
- implementation details
    - process of tailing white-spaces
        - tailing white-spaces results in one more count of the argument
